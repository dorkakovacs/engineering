...
namespace Rendeles_Forms_cgrc42.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=dorkito.database.windows.net;Initial Catalog=Student;Persist Security Info=True;User ID=dorkito;Password=Erasmusomg13;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cim>(entity =>
        {
            entity.HasKey(e => e.CimId).HasName("PK__CIM__8A3BFC16067A787D");
        });

        modelBuilder.Entity<Rendeles>(entity =>
        {
            entity.HasKey(e => e.RendelesId).HasName("PK__RENDELES__8DBDC2ADEB9B242E");
        ...
        {
            entity.HasKey(e => e.TetelId).HasName("PK__RENDELES__18F19F7473C8F26C");
        ...
        {
            entity.HasKey(e => e.TermekId).HasName("PK__TERMEK__05635B296319E264");
        ...
        {
            entity.HasKey(e => e.KategoriaId).HasName("PK__TERMEK_K__37D210EC55766C95");
        ...
        {
            entity.HasKey(e => e.UgyfelId).HasName("PK__UGYFEL__BD19A3715A1DF1FF");
